...
<link href="bootstrap.min.css" rel="stylesheet">
    <body style="background-color: grey; color: whitesmoke;">
        <div class="container" style="height:500px;margin-top: 10%;">
        ...
        <div class="col-lg-12">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="account-edit.php?id=<?php echo $student['id']?>">Edit</a></td>
                    <td><a href="account-list.php?id=<?php echo $student['id']?>&act=del">Delete</a></td>
                </tr>
                    <?php
                }
                ?>
